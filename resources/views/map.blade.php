            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-color.html">Week</a>
                        <a class="collapse-item" href="utilities-border.html">Day</a>
                        <a class="collapse-item" href="utilities-animation.html">Years</a>
