<!-- resources/views/history/day.blade.php -->
{{-- <x-app-layout>
    <x-slot name="header">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">History Day</h1>
                    ...
                    <div class="content mt-3">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">History Aktivitas</strong>
                            </div>
                            <div class="card-body">
...
<head>
    ...
    <!-- Link ke stylesheet atau resources lainnya -->
</head>
<body>
