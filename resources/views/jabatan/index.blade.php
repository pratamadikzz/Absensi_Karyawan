                        ...
                        <div class="animated fadeIn">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Tabel Jabatan</strong>
                                </div>
                                <div class="card-body">
                                    @if (session('success'))
                                ...
                                @endif
                                    ...
                                    <table id="karyawan-table" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ( $allJabatan as $key => $r)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $r->jabatan }}</td>
                                                <td>
                                                    <form action="{{ route('jabatan.destroy', $r->id) }}" method="POST" style="display:inline; "onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                                    <a href="{{ route('jabatan.show', $r->id) }}" class="btn btn-info btn-sm">Detail</a>
                                                    <a href="{{ route('jabatan.edit', $r->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                                        @csrf
                                                        @method('DELETE')
