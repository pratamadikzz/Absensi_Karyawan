                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="" class="dropdown-toggle" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-qrcode"></i>Absen</a>
                        <ul class="sub-menu children dropdown-menu">
                            {{-- <li><i class="menu-icon fa fa-qrcode"></i><a href="">Scan QR Code</a></li> --}}
                            <li><i class="menu-icon fa ti-hand-open"></i><a href="">Ambil QR Code</a></li>
                        </ul>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active"><i class="fa ti-hand-open"></i></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <form action="{{ route('generateQrCode') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="tanggal" name="tanggal" class="form-control" required readonly value="{{ date('Y-m-d') }}">
                    </div>
        ...
        <script>
            ...
            function updateJam() {
                ...
                document.getElementById('jam_tampil').innerText = timeString;
                document.getElementById('jam').value = timeString;
            }

            // Update jam setiap detik
            setInterval(updateJam, 1000);
            updateJam(); // Panggil sekali agar langsung tampil
        </script>
