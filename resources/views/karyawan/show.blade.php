                        ...
                        <div class="animated fadeIn">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Detail Karyawan</strong>
                                </div>
                                <div class="card-body">
                                    <table id="karyawan-table" class="table table-striped table-bordered">
                                        <tbody>
                                            <tr>
                                                <td width="100px">Nama Karyawan</td>
                                                <td width="2px">:</td>
                                                <td>{{ $karyawan->nama }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <!-- Menampilkan QR Code berdasarkan URL yang sudah di-encode -->
                                                    {!! QrCode::size(150)->generate(route('karyawan.show', $karyawan->id)) !!}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
